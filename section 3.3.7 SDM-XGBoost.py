...
if __name__ == "__main__":
    ...
    df_sdm = pd.read_excel("/Users/yangjing/Desktop/dissertation/SDM.xlsx")
    ...
    for day in range(22,29):
        for i in range(0,24):
            ...
            df_temp = df_sdm[df_sdm["date"]==day]
            df_temp = df_temp[df_temp["hour"]==i]
            dic_micro["spatial"].append(df_temp["spatial"].mean())
    x = pd.DataFrame(dic_micro)#generate variables
    ...
    plt.tight_layout()
    plt.savefig("/Users/yangjing/Desktop/dissertation/SDM-XGBoost", dpi=600)
    plt.show()
    print("---------------------------------display evaluation indicators---------------------------------\n")
